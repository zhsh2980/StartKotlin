...
import com.startkotlin.bro.startkotlin.simplewidget.ButtonActivity
import com.startkotlin.bro.startkotlin.simplewidget.SimpleWidgetActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private fun onBtnClick() {
        ...
        btn_chapter_4.setOnClickListener {
            startActivity<SimpleWidgetActivity>()
        }
